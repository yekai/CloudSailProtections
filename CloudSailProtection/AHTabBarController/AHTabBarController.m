...
-(void)presentSubmenuForTabView:(AHTabView*)tabView
{
    ...
    if (!self.submenu) {
        self.submenu = [[UIView alloc] initWithFrame:CGRectMake(0,
                                                                ...
                                                                0)];
        [self.submenu setBackgroundColor:self.selectedColor];
...
{
    if (!_selectedColor) {
        _selectedColor = [UIColor colorWithRed:39/255.0 green:124/255.0 blue:204/255.0 alpha:1];
    }
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.view setBackgroundColor:self.selectedColor];
