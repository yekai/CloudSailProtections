...
-(void)setSelected:(BOOL)selected
{
    ...
    if (selected) {
        ...
        UIColor *tintColor = [UIColor colorWithRed:74/255.0 green:98/255.0 blue:107/255.0 alpha:1];
...
-(void)layoutSubviews
{
    ...
    UIColor *tintColor = self.isSelected ? self.selectedColor : [UIColor colorWithRed:61/255.0 green:89/255.0 blue:98/255.0 alpha:1];
