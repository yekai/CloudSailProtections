...
- (void)initTitleView
{
    ...
    bgView.backgroundColor = [UIColor colorWithRed:104/255.0 green:165/255.0 blue:205/255.0 alpha:1];
    [self.view addSubview:bgView];
    
    UILabel *titleLab = [[UILabel alloc] initWithFrame:CGRectMake((kDeviceWidth - 120) / 2.0, 28, 120, 20)];
    titleLab.text = @"扫描二维码";
