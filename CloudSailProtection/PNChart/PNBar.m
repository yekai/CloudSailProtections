...
-(CATextLayer*)textLayer
{
    if (!_textLayer) {
        ...
        [_textLayer setFontSize:_labelTextFontSize];
...
{
    CGFloat textheigt = self.bounds.size.height;
    ...
    {
        [self.textLayer setString:self.displayText];
    }
    ...
    float verticalY = textheigt-size.height - 10;
